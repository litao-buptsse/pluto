...
public class JDBCUtils {
  ...
  public static Future<ResultSet> asyncExecuteQuery(ExecutorService service,
                                                    PreparedStatement stmt) {
    return service.submit(new ExecuteQueryTask(stmt));
  }

  public static List<Future<ResultSet>> asyncExecuteQuerys(ExecutorService service,
